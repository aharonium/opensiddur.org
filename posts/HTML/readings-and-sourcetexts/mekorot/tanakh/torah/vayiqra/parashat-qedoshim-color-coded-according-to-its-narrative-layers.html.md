...
The Masoretic text presented here is from Rabbi Dr. Seth (Avi) Kadish's <a href="https://he.wikisource.org/wiki/פרשת_קדשים/טעמים">Miqra al pi ha-Mesorah</a>. For the translation in English, I have adapted the translation of Everett Fox in the <a href="https://www.penguinrandomhouse.com/series/DA5/the-schocken-bible">Schocken Bible</a> (1997), mostly to re-Hebraize divine names, place names, names for specific sacred objects and titles, and personal names. Instead of Fox's use of "soil" for <span class="hebrew" lang="he">אדמה</span> (adamah), I use "fertile-ground." In place of "no-gods" for elilim, I use "totems." Instead of "awe," we have used "reverence." Instead of "fowl," we use "bird." Aside from these, I have made minor punctuation changes. --Aharon N. Varady
</body>
</html>