...
וְהַפִּיל בַּקְּרָב הוֹלֵךְ וְקָרֵב
...
<blockquote>
Although the poem bears evidence that the moves in chess have not changed, there are one or two variations of another kind worth noticing. The Indian chessmen have an Elephant to represent the Castle, or Rook, but it is clear that the author of this poem followed the Arabic designation, as he makes the Bishop the Elephant, or <span class="hebrew">פיל</span>, which the Arabs called <em>Al fil</em> (see <em>Encycl. Brit.</em>, vol. 5). It is remarkable that the word Rook, from the Indian "Roch," a "war-chariot," is generally written by Hebrew writers <span class="hebrew">רוק</span>, but the author of this poem employs the word <span class="hebrew">רוח</span>. He may have used the word "wind" metaphorically as a war-chariot...
